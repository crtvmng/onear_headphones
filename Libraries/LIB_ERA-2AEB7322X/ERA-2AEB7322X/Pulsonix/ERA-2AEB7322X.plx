...
//1514525/1884558/2.50/2/2/Resistor
...
(library Library_1
	...
	(symbolDef "ERA-2AEB7322X" (originalName "ERA-2AEB7322X")
	...
	(compDef "ERA-2AEB7322X" (originalName "ERA-2AEB7322X") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ERA-2AEB7322X"))
		...
		(attr "Manufacturer_Part_Number" "ERA-2AEB7322X")
		(attr "Mouser Part Number" "667-ERA-2AEB7322X")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Panasonic/ERA-2AEB7322X?qs=nuXzIS8loXF%252BKBFIF5iByg%3D%3D")
		(attr "Arrow Part Number" "ERA-2AEB7322X")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/era-2aeb7322x/panasonic?utm_currency=USD&region=nac")
		(attr "Description" "Metal Thin Film Chip Resistor, 0402, 0.063W")
		(attr "<Hyperlink>" "http://industrial.panasonic.com/cdbs/www-data/pdf/RDM0000/AOA0000C307.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "ERA-2AEB7322X.stp")
